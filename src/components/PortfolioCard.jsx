// Icon components for different portfolio types
const IconComponents = {
  ...
  'palette': () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM7 3V1M7 23v-2M1 7h6M1 17h6M7 8l4-4 4 4" />
    </svg>
  ),
  'trophy': () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  'clapperboard': () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2M7 4h10M7 4L5.5 6M17 4l1.5 2M3 6h18l-2 14H5L3 6z" />
    </svg>
  ),
  'globe': () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const PortfolioCard = ({ portfolio }) => {
  const IconComponent = IconComponents[portfolio.icon] || IconComponents['globe'];
